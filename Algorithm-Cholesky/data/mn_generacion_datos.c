...
main(){
  ...
  mn_escribir_vector("b_10.txt",b);
  mn_escribir_matriz("A_10.txt",A);
  ...
  // ESCRIBIMOS EN DISCO LA MATRIZ Y EL VECTOR
  mn_escribir_vector("b_100.txt",b2);
  mn_escribir_matriz("A_100.txt",A2);
  ...
  // ESCRIBIMOS EN DISCO LA MATRIZ Y EL VECTOR
  mn_escribir_vector("b_1000.txt",b3);
  mn_escribir_matriz("A_1000.txt",A3);
