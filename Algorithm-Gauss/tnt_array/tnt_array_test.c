...
main(){
  ...
  int dimension=an_leer_vector("../datos/b_cholesky_1.txt",b);
  ...
  Array2D< real >  A;
  dimension=an_leer_matriz("../datos/A_cholesky_1.txt",A);
  if(dimension<=0){ system("pause");  exit(1); }
  ...
  an_escribir_vector("vector.txt",g); 
  an_escribir_matriz("matriz.txt",A_T); 
